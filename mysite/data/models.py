...
class AMA1(models.Model):
	...
	grievance_category = models.CharField(null=True, blank=True, max_length = 255, choices = grievance_categories)
	...
	entity_involved =  models.CharField(null=True, blank=True, max_length = 255, choices = entities)
